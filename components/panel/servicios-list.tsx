  ...
  return (
    <div className="space-y-4">
      {servicios.map((servicio) => (
        <div key={servicio.id} className="p-3 sm:p-4 border rounded-lg">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="flex-1">
              <div className="flex items-center gap-2 sm:gap-3 mb-2">
                <h4 className="font-semibold text-base sm:text-lg">{servicio.name}</h4>
                {!servicio.is_active && <Badge variant="outline" className="text-xs">Inactivo</Badge>}
              </div>
              {servicio.description && <p className="text-xs sm:text-sm text-muted-foreground mb-2 sm:mb-3">{servicio.description}</p>}
            ...
            <div className="flex items-center gap-2 sm:gap-3 justify-between sm:justify-start">
              <div className="flex items-center gap-2">
                <span className="text-xs sm:text-sm text-muted-foreground">Activo</span>
                <Switch
